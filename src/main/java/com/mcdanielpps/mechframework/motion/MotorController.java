...
public class MotorController {
    ...
    public double Update(TelemetryPacket packet, String name) {
        ...
        packet.put(name + ", Position", m_CurrentPosition);
        packet.put(name + ", Goal", Goal);
        packet.put(name + ", Power", output / 100.0);
